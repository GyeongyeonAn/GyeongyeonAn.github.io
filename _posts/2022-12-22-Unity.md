...
public class CreateMonster : MonoBehaviour
{
    private void Start()
    {
        ...
        // 좌표 이동 후에 부모로 설정하는 순서를 지켜야 위치가 정확하게 맞춰진다.
...
![image](https://user-images.githubusercontent.com/55589616/213092193-8a83f939-4366-49e0-86c5-3391f41ecadb.png)
